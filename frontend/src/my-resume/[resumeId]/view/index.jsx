...
import ResumePDF from "@/dashboard/components/ResumePDF"; // Import the PDF component
...
function ViewResume() {
  ...
  const GetResumeInfo = async () => {
    ...
    try {
      ...
      setResumeInfo(response.data.data); // Set resume data
    } catch (error) {
  ...
  // Fetch resume data on component mount or when resumeId changes
  useEffect(() => {
    GetResumeInfo();
  }, [resumeId]);
        ...
        <div className="my-10 mx-10 md:mx-20 lg:mx-36">
          ...
          <div className="flex justify-between items-center px-44 my-10">
            ...
            <PDFDownloadLink
              ...
              fileName={`${resumeInfo?.personalDetails?.firstName}_Resume.pdf`}
            >
              {({ loading }) => (
